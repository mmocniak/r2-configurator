/* Rivian R1T — vehicle spec + accessory data.
   ...
   VERIFIED 2026-07-09 against Rivian's own R1T builder page payload
   (rivian.com/configurations/builder/r1t — trim/pack deltas, paint, wheel-package,
...
VEHICLES.r1t = {
  ...
  /* Hero renders come from Rivian's layer compositor (see heroURL in app.js):
     media.rivian.com/rivian-main/…/compositor/r1t/side/{codes} with sprite set 2023.1 —
  ...
  img:{compositor:'r1t',view:'side',ver:'2023.1',program:'gold-iris'},
  flagshipTrim:'quad',

  /* Builder paint prices, decoded from rivian.com's R1T builder payload (2026-07).
