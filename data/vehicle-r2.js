...
VEHICLES.r2 = {
  ...
  accessories:[
    ...
    {grp:'Cargo, utility & protection',items:[
      ...
      {id:'carcover',name:'Outdoor Car Cover',price:450,icon:'box',img:'https://gearshop.rivian.com/cdn/shop/files/20260307_GOODRICH_R2_CANYONRANCH-0853_3000px-FINAL.jpg?v=1783553301&width=240',link:'https://gearshop.rivian.com/products/r2-outdoor-car-cover',note:'Custom-fit, water-resistant, breathable cover with storage bag; also orderable with the car in Rivian’s builder.'},
