...
const TRIMS={
  ...
  premium:{name:'R2 Premium',short:'Premium',price:53990,drive:'AWD',motors:'Dual-motor',hp:450,range:330,z60:'4.6s',tow:'4,400 lb',avail:'Late 2026',folder:'premium',
    ...
    interior:[{id:'pbc',code:'INT-PBC',name:'Black Crater Signature',price:0,note:'Included'},{id:'pcc',code:'INT-PCC',name:'Coastal Cloud Signature',price:1000,avail:'August 2026'}],
...
const CMP_ACCESSORIES=[
  ...
  {grp:'Cargo, utility & protection',items:[
    ...
    {id:'cargocover',name:'Cargo Cover',price:200,icon:'box',img:GEAR_IMG+'files/CargoCover_R2.png?v=1778789991&width=240',link:'https://gearshop.rivian.com/products/r2-cargo-cover',avail:'Coming soon',note:'Retractable cover that keeps rear storage out of sight.'},
    ...
    {id:'kitchen',name:'Travel Kitchen',price:1400,icon:'utensils',img:GEAR_IMG+'files/Travel-Kitchen-Hero.jpg?v=1752682568&width=240',link:'https://gearshop.rivian.com/products/travel-kitchen',note:'Portable camp kitchen with induction cooktop; pairs with Camp Mode.'},
